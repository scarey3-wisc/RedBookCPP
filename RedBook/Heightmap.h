...
using HeightmapBase = RegionalSkirtedCellDataRasterManager<int32_t, Heightmap>::LimitedDataRasterHandle;

class Heightmap : public RegionalSkirtedCellDataRasterManager<int32_t, Heightmap>::DataRasterHandle
{
public:
...
class HeightmapManager : public MultiLODRegionalSkirtedCellDataRasterManager<int32_t, Heightmap>
{
public:
